...
class Hospital {
  ...
  factory Hospital.fromJson(Map<String, dynamic> json) {
    ...
    return Hospital(
      ...
      emergencyNum:
          json['emergencyNum']?.toString() ??
          json['Emergency_Num']?.toString() ??
          '',
      bloodbankPhone:
          json['bloodbankPhone']?.toString() ??
      ...
      specialties: _parseStringToList(
        json['specialties'] ?? json['Specialties'],
      ),
      ...
      totalBeds:
          _parseInt(
            json['totalBeds'] ?? json['Total_Num_Beds'] ?? json['totalNumBeds'],
          ) ??
          0,
      availableBeds:
