...
class MapScreen extends StatefulWidget {
  ...
  const MapScreen({super.key, required this.hospitals, this.currentPosition});
        ...
        markers.add(
          Marker(
            ...
            infoWindow: InfoWindow(
              title: hospital.name,
              snippet:
                  '${hospital.availableBeds} beds available • ${hospital.category}',
            ),
    ...
    switch (_selectedFilter) {
      ...
      case 'government':
        return widget.hospitals
            .where(
              (h) =>
                  h.category.toLowerCase().contains('government') ||
